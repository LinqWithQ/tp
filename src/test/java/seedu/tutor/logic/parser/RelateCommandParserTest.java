...
public class RelateCommandParserTest {
    ...
    private final String[] validInput = new String[] {" a\\test/test/test/test", " a\\1/1/1/1 a\\2/2/2/2",
    ...
    private final String[] invalidInput = new String[] {" a\\", " d\\", " a\\1", " d\\2/2", " a\\3/3/3",
